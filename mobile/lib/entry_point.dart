      ...
      child: ScreenUtilInit(
        ...
        builder: (context, child) => MultiBlocProvider(
          providers: [
            ...
            BlocProvider(create: (_) => di.sl<MyPendingVideoDeepfakeBloc>()),
            BlocProvider(create: (_) => di.sl<MyVideoDeepfakeBloc>()),
            BlocProvider(create: (_) => di.sl<DeepfakeBloc>()),
            BlocProvider(create: (_) => di.sl<MyChildrenBloc>()),
            BlocProvider(create: (_) => di.sl<ListScheduleBloc>()),
          ],
