...
class AppColors {
  ...
  static const grad1Color = Color(0xff0e7134);
  static const grad2Color = Color(0xff368d31);
  ...
  static const facebookBackgroundColor = Color(0xff2e74e9);
  static const googleBackgroundColor = Color(0xffe54543);

  static const infoColor = Color(0xFF47AFFF);
  static const successColor = Color(0xFF32BC32);
  static const warningColor = Color(0xFFFFB600);
  static const errorColor = Color(0xFFFF3A30);
}
